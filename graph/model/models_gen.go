...
type BankTranslationWhereInput struct {
	...
	BankIdneq   *string  `json:"bankIDNEQ,omitempty"`
	BankIDIn    []string `json:"bankIDIn,omitempty"`
	BankIDNotIn []string `json:"bankIDNotIn,omitempty"`
...
type CreateBankInput struct {
	...
	TranslationIDs  []string `json:"translationIDs,omitempty"`
}
...
type UpdateBankInput struct {
	...
	AddTranslationIDs     []string `json:"addTranslationIDs,omitempty"`
	RemoveTranslationIDs  []string `json:"removeTranslationIDs,omitempty"`
	ClearTranslations     *bool    `json:"clearTranslations,omitempty"`
}
